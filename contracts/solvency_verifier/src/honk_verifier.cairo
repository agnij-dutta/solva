...
use super::honk_verifier_circuits::{
    run_GRUMPKIN_ZK_HONK_SUMCHECK_SIZE_15_PUB_18_circuit,
    ...
    run_GRUMPKIN_ZK_HONK_EVALS_CONS_DONE_SIZE_15_circuit, is_on_curve_excluding_infinity_bn254
};
...
mod UltraKeccakZKHonkVerifier {
    use garaga::definitions::{
        G1Point, G1G2Pair, BN254, get_BN254_modulus, get_GRUMPKIN_modulus, u384, get_eigenvalue,
        get_third_root_of_unity, get_min_one_order, get_nG_glv_fake_glv
    };
    ...
    use super::{
        vk, precomputed_lines, run_GRUMPKIN_ZK_HONK_SUMCHECK_SIZE_15_PUB_18_circuit,
        run_GRUMPKIN_ZKHONK_PREP_MSM_SCALARS_SIZE_15_circuit,
        run_GRUMPKIN_ZK_HONK_EVALS_CONS_INIT_SIZE_15_circuit,
        run_GRUMPKIN_ZK_HONK_EVALS_CONS_LOOP_SIZE_15_circuit,
        run_GRUMPKIN_ZK_HONK_EVALS_CONS_DONE_SIZE_15_circuit, is_on_curve_excluding_infinity_bn254
    ...
    use garaga::apps::noir::zk_honk_transcript::{
        Point256IntoCircuitPoint, KeccakHasherState, ZKHonkTranscriptTrait,
    ...
    impl IUltraKeccakZKHonkVerifier of super::IUltraKeccakZKHonkVerifier<ContractState> {
        fn verify_ultra_keccak_zk_honk_proof(
            ...
            let (sum_check_rlc, honk_check) = run_GRUMPKIN_ZK_HONK_SUMCHECK_SIZE_15_PUB_18_circuit(
                ...
                ..vk
                    .log_circuit_size {
                        let (new_challenge_poly_eval, new_root_power_times_tp_gemini_r) =
                            ...
                            tp_sumcheck_u_challenge: (*transcript.sum_check_u_challenges.at(i))
                                .into(),
                            modulus: mod_grumpkin,
                        );
            ...
            // Skip the first 28 points as they are from VK and keep the last 27 proof points
            for point in points
                .slice(
                    28, 27
                ) {
            ...
            assert(
                is_on_curve_excluding_infinity_bn254(shplonk_q_pt, mod_bn), 'shplonk_q not on curve'
            );
